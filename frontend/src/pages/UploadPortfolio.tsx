...
function UploadPortfolio() {
  ...
  const renderInstructions = () => (
    <>
      ...
      <p>
        Once your portfolio is uploaded, our platform employs a sophisticated algorithm to assess the
        <strong> Environmental, Social, and Governance (ESG)</strong> performance of each company within your holdings. This algorithm considers a variety of factors to determine the ESG score, providing a holistic view of how well a company aligns with sustainable and responsible business practices.
      </p>
      <h2>
      ...
      >
        <Grid item>
          {fileObjects.length === 0 ? (
            <>
              <h1>
                <strong>Upload Your Yahoo Finance Portfolio For Evaluation 📈</strong>
              </h1>
              {renderInstructions()}
              <Box 
              display="flex"
            ...
            <>
              ...
              {renderInstructions()}
              <Paper sx={{ padding: '10px', backgroundColor: '#565656', color: 'white', margin: '40px 0 20px 0'}} elevation={1}>
